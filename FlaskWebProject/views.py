...
def home():
    ...
    app.logger.info('You are at Home page')
...
@login_required
def new_post():
    app.logger.info('You are creating a new post')
...
@login_required
def post(id):
    app.logger.info('You are posting a new post')
...
def login():
    app.logger.info('You are logging')
